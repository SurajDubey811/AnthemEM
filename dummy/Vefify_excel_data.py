        ...
        for calc_sit in ele.findall(f".//{namespace}calculationSituation"):
            ...
            if calc_sit_level == ben_comp_level:
                ...
                if (calc_sit.find(".//ns5:placeOfServiceType", namespaces=namespaces)) is not None:
                    if calc_sit_level == get_element_level(
                            calc_sit.find(".//ns5:placeOfServiceType", namespaces=namespaces)):
                        row_dict['POS'] = (calc_sit.find(".//ns5:placeOfServiceType", namespaces=namespaces)).get(
                            'id')
                        row_dict['POS_DESC'] = (
                            calc_sit.find(".//ns5:placeOfServiceType", namespaces=namespaces)).get(
                            'desc')
                else:
                ...
                if (calc_sit.find(".//ns5:specialtyCode", namespaces=namespaces)) is not None:
                    if calc_sit_level == get_element_level(
                            calc_sit.find(".//ns5:specialtyCode", namespaces=namespaces)):
                ...
                if (calc_sit.find(".//ns5:situationGroup", namespaces=namespaces)) is not None:
                    sit_grp = calc_sit.find(".//ns5:situationGroup", namespaces=namespaces)
                    ...
                    if calc_sit_level == sit_grp_level:
                        row_dict['SIT_GRP_ID'] = (calc_sit.find(".//ns5:situationGroup", namespaces=namespaces)). \
                            get('id')
                        row_dict['SIT_GRP_DESC'] = (calc_sit.find(".//ns5:situationGroup", namespaces=namespaces)). \
                            get('desc')

                        if (calc_sit.find(".//ns5:calculationType", namespaces=namespaces)) is not None:
                            if sit_grp_level == get_element_level(
                                    calc_sit.find(".//ns5:calculationType", namespaces=namespaces)):
                                row_dict["CAL_TYPE_VAL"] = (
                                    calc_sit.find(".//ns5:calculationType", namespaces=namespaces)).get(
                                    'value')

                        if (calc_sit.find(".//ns5:examinerActionCode", namespaces=namespaces)) is not None:
                            if sit_grp_level == get_element_level(
                                    calc_sit.find(".//ns5:examinerActionCode", namespaces=namespaces)):
                        ...
                        if len(sit_grp.findall(".//ns5:calculationStep", namespaces=namespaces)) > 0:
                            for benefit_option in sit_grp.findall(".//ns5:benefitOption", namespaces=namespaces):
                                if benefit_option.find(".//ns5:benefitType", namespaces=namespaces).get(
                                        "value") == "Coinsurance":
                                    row_dict["COIN"] = "Yes"
                                    row_dict["COIN_BO_NAME"] = benefit_option.get("name")
                                    row_dict["COIN_BO_DESC"] = benefit_option.get("desc")
                                    row_dict["COIN_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                               namespaces=namespaces).text
                                    row_dict["COIN_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                  namespaces=namespaces).get(
                                        'value')
                                    row_dict["COIN_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                                                                     namespaces=namespaces).get(
                                        'value'))
                                    if benefit_option.find(".//ns5:claimsAccumulatorName",
                                ...
                                elif benefit_option.find(".//ns5:benefitType", namespaces=namespaces).get("value") == \
                                        "Copayment":
                                    benefit = benefit_option.find(".//ns5:benefitType", namespaces=namespaces)
                                    row_dict["COPAY"] = "Yes"
                                    row_dict["COPAY_BO_NAME"] = benefit_option.get("name")
                                    row_dict["COPAY_BO_DESC"] = benefit_option.get("desc")
                                    row_dict["COPAY_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                                namespaces=namespaces).text
                                    row_dict["COPAY_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                   namespaces=namespaces).get(
                                        'value')
                                    row_dict["COPAY_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                                                                      namespaces=namespaces).get(
                                        'value'))
                                    if benefit_option.find('.//ns5:claimsAccumulatorName',
                                                           namespaces=namespaces) is not None:
                                    ...
                                    row_dict["DED_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                              namespaces=namespaces).text
                                    row_dict["DED_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                 namespaces=namespaces).get(
                                        'value')
                                    row_dict["DED_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                    ...
                                    row_dict["DED_AGG_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                                  namespaces=namespaces).text
                                    row_dict["DED_AGG_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                     namespaces=namespaces).get(
                                        'value')
                                    row_dict["DED_AGG_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                                                                        namespaces=namespaces).get(
                                        'value'))
                                    if benefit_option.find(".//ns5:claimsAccumulatorName",
                                                           namespaces=namespaces) is not None:
                                        row_dict['DED_AGG_ACCUM'] = benefit_option.find(
                                            ".//ns5:claimsAccumulatorName",
                                            namespaces=namespaces).get(
                                            'value')
                                    else:
                                ...
                                elif benefit_option.find(".//ns5:benefitType", namespaces=namespaces).get(
                                        "value") == "DollarLimit":
                                    row_dict["DOL_LMT"] = "Yes"
                                    row_dict["DOL_LMT_BO_NAME"] = benefit_option.get("name")
                                    row_dict["DOL_LMT_BO_DESC"] = benefit_option.get("desc")
                                    row_dict["DOL_LMT_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                                  namespaces=namespaces).text
                                    row_dict["DOL_LMT_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                     namespaces=namespaces).get(
                                        'value')
                                    row_dict["DOL_LMT_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                                                                        namespaces=namespaces).get(
                                        'value'))
                                    if benefit_option.find(".//ns5:claimsAccumulatorName",
                                                           namespaces=namespaces) is not None:
                                    ...
                                    row_dict["UNIT_VAL"] = benefit_option.find(".//ns5:benefitValue",
                                                                               namespaces=namespaces).text
                                    row_dict["UNIT_PERIOD"] = benefit_option.find(".//ns5:benefitPeriod",
                                                                                  namespaces=namespaces).get(
                                        'value')
                                    row_dict["UNIT_EOB"] = float(benefit_option.find(".//ns5:eobCode",
                                                                                     namespaces=namespaces).get(
                                        'value'))
                                    if benefit_option.find(".//ns5:claimsAccumulatorName",
                                                           namespaces=namespaces) is not None:
